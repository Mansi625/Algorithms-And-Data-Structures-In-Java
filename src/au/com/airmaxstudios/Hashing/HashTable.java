package au.com.airmaxstudios.Hashing;
...
public class HashTable
{
    ...
    void insert(String key, String value) {
        ...
        mTable[calcHash(key)] = entry;

        if(mTable[calcHash(key)] != null){

            int currentPos = calcHash(key);

            while(mTable[currentPos] !=null){
                currentPos++;
            }

            mTable[currentPos] = entry;
        }else{
            mTable[calcHash(key)] = entry;
        }
    ...
    String lookup(String key)
    {
        ...
        /*while(result != key)
        {
            result = mTable[hashKey].value;


        }*/

        System.out.println("Found City: " + result);
        return null;
    } // end of lookup()
